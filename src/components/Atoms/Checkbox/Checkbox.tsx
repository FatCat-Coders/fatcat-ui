		...
		>
			...
			>
				{!icon && (isIndeterminate ? (
					<CheckIcon width="14" height="2" viewBox="0 0 14 2" fill="#F9F9F9" xmlns="http://www.w3.org/2000/svg">
						<path d="M1 .05a.95.95 0 1 0 0 1.9V.05Zm12 1.9a.95.95 0 0 0 0-1.9v1.9Zm-12 0h12V.05H1v1.9Z" />
					</CheckIcon>
				) : (
					<CheckIcon width="12" height="9" viewBox="0 0 12 9" fill="#F9F9F9" xmlns="http://www.w3.org/2000/svg">
